    ...
    <div class="container relative flex items-center justify-between mx-auto">
      ...
      <div>
        ...
        <div class="flex items-center gap-5">
          <h1 class="text-xl text-white">Xin chào {{ userInfor.name }}!</h1>
          <div>
            ...
            <div
              ...
              <div class="flex justify-end">
                <label for="notification" class="p-2 text-xl text-white cursor-pointer hover:opacity-75">
                  <i class="fa-solid fa-xmark"></i>
                </label>
              </div>
              <ul class="py-2 pr-2 mr-2 max-h-[500px] overflow-y-scroll flex flex-col gap-2 rounded-xl scrollbar">
                <li
              ...
              <svg class="w-full my-2 animate-spin" width="30" height="30" viewBox="0 0 24 24"
                ...
                <path d="M12,1A11,11,0,1,0,23,12,11,11,0,0,0,12,1Zm0,19a8,8,0,1,1,8-8A8,8,0,0,1,12,20Z" fill="white"
                  opacity=".25" />
                <path fill="white"
          ...
          <div>
            <label for="menu">
              <img class="w-10 rounded-full cursor-pointer hover:opacity-75" :src="userInfor?.avatar"
                :alt="userInfor?.name" :title="userInfor?.name" :onerror="'../ assets / W02 / avatar'">
            </label>
              ...
              <ul class="flex flex-col gap-4 py-2 ml-2 mr-8 text-lg">
                <li>
                  ...
                  <div
                    ...
                    <div class="bg-[#121212] w-[800px]  rounded-xl outline outline-2 outline-[#383838] overflow-hidden">
                      <div class="flex justify-end bg-black">
                        <label for="modal_live" class="p-4 text-xl text-white cursor-pointer hover:opacity-75">
                          <i class="fa-solid fa-xmark"></i>
                        </label>
                      </div>
                      ...
                      <div class="grid grid-cols-2 gap-5 px-5 py-3">
                        ...
                        <div class="flex flex-col gap-4">
                          <div class="flex flex-col gap-2">
                            <label for="modal_live_title" class="text-xl font-medium text-white cursor-pointer">Tiêu
                              đề</label>
                            <input
                              ...
                              type="text" id="modal_live_title" placeholder="Điền tiêu đề...">
                          </div>
                          <div class="flex flex-col gap-2">
                            <label for="modal_live_date" class="text-lg font-medium text-white cursor-pointer">Chọn
                              thời
                              gian</label>
                            <input
                ...
                <li>
                  ...
                  <div
                    ...
                    <div
                      ...
                      <div class="flex justify-end bg-black">
                        <label for="modal_info" class="p-4 text-xl text-white cursor-pointer hover:opacity-75">
                          <i class="fa-solid fa-xmark"></i>
                        </label>
                      </div>
...
export default {
  ...
  mounted() {
     ...
     ******************** Once created, the interface is displayed and calls mounted. **************************
        **********************************************************************************************************/
    this.userInfor = JSON.parse(sessionStorage.getItem('user_infor'));
  },
  watch: {
    /***********************************************************************************************************
